      ...
      <div className="max-w-5xl w-full bg-white shadow-lg rounded-lg overflow-hidden relative print:shadow-none">
        ...
        <div className="p-6 sm:p-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-16 reveal fade-slide">
            ...
            {/* LOGO + TITLE */}
            <div>
              <img src="/logo.jpeg" alt="Infinity Logo" className="h-20 sm:h-24 mb-4 sm:mb-6" />
          ...
          <div className="text-gray-800 text-base sm:text-lg leading-relaxed space-y-5 sm:space-y-6 mb-20 reveal fade">
            <p>
              When we started this business, it wasn't just about products;
              it was about protecting the people we care about. As a company,
              we carefully choose which safety solutions to bring to you.
            </p>
            ...
            <p>
              ...
              products; we partner with manufacturers who share our
              commitment to quality and reliability.
            </p>

            <p>
              When you call us about protecting your office, school, or home,
              we see the real people behind that request. That's why we work
          ...
          <div className="mb-10 reveal fade-slide text-center sm:text-left">
            ...
            <p className="text-gray-600 text-lg sm:text-xl">Professional Team</p>
          </div>
            ...
            {[
              {
                ...
                desc:
                  "23+ years of experience in Sales & Marketing with expertise in door hardware, glass and fire & safety products.",
              },
              {
                img: "/expert1.png",
                ...
                desc:
                  "12 years of experience in Office Management & Finance ensuring smooth operations and financial excellence.",
              },
              {
                img: "/expert2.png",
                ...
                desc:
                  "24+ years in Marketing & Sales, leading national business development strategies and client relations.",
              },
              {
                img: "/expert3.png",
                name: "Rakesh Sharma",
                ...
                desc:
                  "15+ years of experience in large-scale fire safety project execution and leadership.",
              },
              {
                img: "/expert4.png",
                name: "Priya Verma",
                ...
                desc:
                  "Expert in financial planning, budgeting, and administrative operations for structured growth.",
              },
              {
                img: "/expert5.png",
                name: "Suresh Khanna",
                ...
                desc:
                  "Specialist in fire safety technologies with 18+ years of implementation expertise.",
              },
            ].map((member, index) => (
              <div
                key={index}
