    ...
    /> */}
      ...
      <div className="w-full bg-white font-sans">
        ...
        <div className="px-4 md:px-10 pt-10 md:pt-12 max-w-6xl mx-auto">
          ...
          <div className="w-full h-0.5 bg-blue-900 mt-4" />
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div className="text-gray-800 leading-relaxed text-base md:text-lg">
              <p>
                ...
                property, and critical infrastructure through cutting-edge
                technology, certified products, and a commitment to excellence.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-10">
            ...
            <div>
              ...
              <p className="mt-3 text-gray-800 leading-relaxed text-sm md:text-base">
                Fire glass stays clear in daily use but becomes a protective
                barrier during emergencies—ensuring visibility and safety.
              </p>
            </div>
