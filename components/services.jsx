...
export default function FireProductsPage() {
  return (
    <div className="w-full bg-white text-gray-800 pb-20">
      ...
      <div className="relative bg-gray-100 py-12 mt-20 flex justify-center">
        {/* Red Side Bar */}
      ...
      <div className="w-full bg-white text-gray-800">
        ...
        {/* PAGE TITLE */}
        <div className="w-full px-6 md:px-16 pt-12">
          <h1 className="text-[32px] sm:text-[42px] md:text-[58px] font-bold text-[#b40000]">
            LED Lightings
          </h1>
        </div>
          ...
          {[
            ...
            <div key={idx} className="relative">
              <img
                src={item.src}
                alt={item.label}
                className="w-full h-56 sm:h-72 md:h-80 object-cover rounded-lg shadow"
              />
      ...
      <div className="w-full bg-white text-black font-sans">
        ...
        <section className="mt-10 bg-red-600 text-white p-6 sm:p-10">
        ...
        {/* Thank You Section */}
        <div className="w-full bg-white text-black font-sans">
          <div className="flex justify-center items-center px-6 md:px-20 mt-10 sm:mt-20 pt-10">
            <Image
              src="/india.png"
              alt="India Map"
              width={1000}
